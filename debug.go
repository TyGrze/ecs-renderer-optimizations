...
func (d *DebugOverlay) Draw(sr *SpriteRenderer) {
	// DPI scale from window scale factor
	...
	lineHeight := int32(20) * dpi
	paddingX := int32(10) * dpi
	paddingY := int32(10) * dpi
	panelWidth := int32(280) * dpi
	...
	panelHeight := int32(len(lines))*lineHeight + paddingY*2
